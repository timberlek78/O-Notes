<?php
class EtudiantEtudiantSemestre
{
	//clé primaire
	...
	public function __construct( string $codenip="", string $nom="", string $prenom="", string $parcours="", string $promotion="", string $specialite="", string $typebac="", int $numSemestre=-1, string $passage="", int $rang=-1, int $nbAbsences=-1 )
	{
